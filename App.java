...
class App {
    ...
    /**
     * Método que executa o menu da aplicação e realiza as operações conforme a escolha do usuário.
     * 
     */
        ...
        do {
            ...
            switch (escolha) {
                ...
                case 6:
                    ...
                    // Tratamento de exceção, caso a pessoa digite um time que não existe
                    if (jogo.validaTime(timeEscolhido)) {
                        System.out.printf("\nPorcentagem de vitórias em relação ao número de jogos do " + timeEscolhido + " foi de %.2f %%", jogo.mediaVitTime(timeEscolhido));
                    } else {
                        System.out.printf("\nSinto muito, mas parece que " + timeEscolhido + " não se encontra na lista de times classificados,\n"
    ...
    /**
     * Exibe o menu de opções da aplicação.
     */
    public static void menu() {
        ...
        System.out.printf("\n6 Porcentagem de vitórias em relação ao número de jogos");
